...
class TLSConnection(TLSRecordLayer):
    ...
    @deprecated_params({'async_': 'async'}, "'{old_name}' is a keyword in Python 3.7, use'{new_name}'")
    def handshakeClientSRP(self, username, password, session=None, settings=None, checker=None, reqTack=True, serverName=None, async_=False):
    ...
    @deprecated_params({'async_': 'async'}, "'{old_name}' is a keyword in Python 3.7, use'{new_name}'")
    def handshakeClientCert(self, certChain=None, privateKey=None, session=None, settings=None, checker=None, nextProtos=None, reqTack=True, serverName=None, async_=False, alpn=None):
    ...
    def handshakeServer(self, verifierDB=None, certChain=None, privateKey=None, reqCert=False, sessionCache=None, settings=None, checker=None, reqCAs=None, tacks=None, activationFlags=0, nextProtos=None, anon=False, alpn=None, sni=None):
    ...
    def handshakeServerAsync(self, verifierDB=None, certChain=None, privateKey=None, reqCert=False, sessionCache=None, settings=None, checker=None, reqCAs=None, tacks=None, activationFlags=0, nextProtos=None, anon=False, alpn=None, sni=None):
    ...
    def _serverTLS13Handshake(self, settings, clientHello, cipherSuite, privateKey, serverCertChain, version, scheme, srv_alpns, reqCert):
    ...
    @staticmethod
    def _pickServerKeyExchangeSig(settings, clientHello, certList=None, private_key=None, version=(3, 3), check_alt=True):
