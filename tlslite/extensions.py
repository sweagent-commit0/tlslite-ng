...
class TLSExtension(object):
    ...
    def __init__(self, server=False, extType=None, encExt=False, cert=False, hrr=False):
        """
    ...
    def __eq__(self, that):
        ...
        if hasattr(that, 'extType') and hasattr(that, 'extData'):
            return self.extType == that.extType and self.extData == that.extData
        return False
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return 'TLSExtension(extType={0!r}, extData={1!r}, serverType={2!r}, encExtType={3!r})'.format(self.extType, self.extData, self.serverType, self.encExtType)
...
class CustomNameExtension(TLSExtension):
    ...
    def __getattr__(self, name):
        ...
        if name == '_field_name':
            raise AttributeError("type object '{0}' has no attribute '{1}'".format(self.__class__.__name__, name))
...
class VarBytesExtension(CustomNameExtension):
    ...
    def __repr__(self):
        ...
        if self._internal_value is not None:
            return '{0}(len({1})={2})'.format(self.__class__.__name__, self._field_name, len(self._internal_value))
...
class ListExtension(CustomNameExtension):
    ...
    def __repr__(self):
        """Return human readable representation of the extension."""
        return '{0}({1}={2})'.format(self.__class__.__name__, self._field_name, self._list_to_repr())
...
class VarListExtension(ListExtension):
    ...
    def __init__(self, elemLength, lengthLength, fieldName, extType, item_enum=None):
        ...
        """
        super(VarListExtension, self).__init__(fieldName, extType=extType, item_enum=item_enum)
...
class VarSeqListExtension(ListExtension):
    ...
    def __init__(self, elemLength, elemNum, lengthLength, fieldName, extType, item_enum=None):
        """
        ...
        :param class item_enum: TLSEnum class that defines entries in the list
        """
        super(VarSeqListExtension, self).__init__(fieldName, extType=extType, item_enum=item_enum)
        self._elemLength = elemLength
...
class IntExtension(CustomNameExtension):
    ...
    def __repr__(self):
        """Return human readable representation of the extension."""
        return '{0}({1}={2})'.format(self.__class__.__name__, self._field_name, self._entry_to_repr())
...
class SupportedVersionsExtension(VarSeqListExtension):
    ...
    def __init__(self):
        ...
        super(SupportedVersionsExtension, self).__init__(1, 2, 1, 'versions', extType=ExtensionType.supported_versions)
...
class SrvSupportedVersionsExtension(TLSExtension):
    ...
    def __init__(self):
        super(SrvSupportedVersionsExtension, self).__init__(extType=ExtensionType.supported_versions)
        self.version = None
...
class ClientCertTypeExtension(VarListExtension):
    ...
    def __init__(self):
        ...
        See also: :py:meth:`create` and :py:meth:`parse`
        """
        super(ClientCertTypeExtension, self).__init__(1, 1, 'certTypes', ExtensionType.cert_type, CertificateType)
...
class ServerCertTypeExtension(IntExtension):
    ...
    def __init__(self):
        ...
        See also: :py:meth:`create` and :py:meth:`parse`
        """
        super(ServerCertTypeExtension, self).__init__(1, 'cert_type', ext_type=ExtensionType.cert_type, item_enum=CertificateType)
...
class TACKExtension(TLSExtension):
    ...
    class TACK(object):
        ...
        def __repr__(self):
            ...
            :rtype: str
            """
            return 'TACK(public_key={0!r}, min_generation={1!r}, generation={2!r}, expiration={3!r}, target_hash={4!r}, signature={5!r})'.format(self.public_key, self.min_generation, self.generation, self.expiration, self.target_hash, self.signature)

        def create(self, public_key, min_generation, generation, expiration, target_hash, signature):
            """
        ...
        def __eq__(self, other):
            ...
            """
            if hasattr(other, 'public_key') and hasattr(other, 'min_generation') and hasattr(other, 'generation') and hasattr(other, 'expiration') and hasattr(other, 'target_hash') and hasattr(other, 'signature'):
                if self.public_key == other.public_key and self.min_generation == other.min_generation and (self.generation == other.generation) and (self.expiration == other.expiration) and (self.target_hash == other.target_hash) and (self.signature == other.signature):
                    return True
                else:
                    return False
            else:
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return 'TACKExtension(activation_flags={0!r}, tacks={1!r})'.format(self.activation_flags, self.tacks)
...
class SupportedGroupsExtension(VarListExtension):
    ...
    def __init__(self):
        ...
        super(SupportedGroupsExtension, self).__init__(2, 2, 'groups', ExtensionType.supported_groups, GroupName)
...
class ECPointFormatsExtension(VarListExtension):
    ...
    def __init__(self):
        """Create instance of class"""
        super(ECPointFormatsExtension, self).__init__(1, 1, 'formats', ExtensionType.ec_point_formats, ECPointFormat)
...
class SignatureAlgorithmsExtension(_SigListExt):
    ...
    def __init__(self):
        """Create instance of class"""
        super(SignatureAlgorithmsExtension, self).__init__(1, 2, 2, 'sigalgs', ExtensionType.signature_algorithms, SignatureScheme)
...
class SignatureAlgorithmsCertExtension(_SigListExt):
    ...
    def __init__(self):
        """Create instance of class."""
        super(SignatureAlgorithmsCertExtension, self).__init__(1, 2, 2, 'sigalgs', ExtensionType.signature_algorithms_cert, SignatureScheme)
...
class RenegotiationInfoExtension(VarBytesExtension):
    ...
    def __init__(self):
        ...
        super(RenegotiationInfoExtension, self).__init__('renegotiated_connection', 1, extType)
...
class StatusRequestExtension(TLSExtension):
    ...
    def __init__(self):
        ...
        super(StatusRequestExtension, self).__init__(extType=ExtensionType.status_request)
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return 'StatusRequestExtension(status_type={0}, responder_id_list={1!r}, request_extensions={2!r})'.format(self.status_type, self.responder_id_list, self.request_extensions)
    ...
    def create(self, status_type=CertificateStatusType.ocsp, responder_id_list=tuple(), request_extensions=b''):
        """
...
class KeyShareEntry(object):
    ...
    def __repr__(self):
        ...
        return 'KeyShareEntry(group={0},key_exchange={1})'.format(GroupName.toStr(self.group), repr(self.key_exchange))
...
class HeartbeatExtension(IntExtension):
    ...
    def __init__(self):
        super(HeartbeatExtension, self).__init__(1, 'mode', ext_type=ExtensionType.heartbeat, item_enum=HeartbeatMode)
...
class ClientKeyShareExtension(TLSExtension):
    ...
    def __init__(self):
        ...
        super(ClientKeyShareExtension, self).__init__(extType=ExtensionType.key_share)
    ...
    def __repr__(self):
        ...
        return 'ClientKeyShareExtension(client_shares=[{0}])'.format(','.join((repr(i) for i in self.client_shares)))
...
class ServerKeyShareExtension(TLSExtension):
    ...
    def __init__(self):
        """Create instance of the object."""
        super(ServerKeyShareExtension, self).__init__(extType=ExtensionType.key_share, server=True)
...
class HRRKeyShareExtension(TLSExtension):
    ...
    def __init__(self):
        """Create instance of the object."""
        super(HRRKeyShareExtension, self).__init__(extType=ExtensionType.key_share, hrr=True)
...
class PreSharedKeyExtension(TLSExtension):
    ...
    def __init__(self):
        """Create instance of class."""
        super(PreSharedKeyExtension, self).__init__(extType=ExtensionType.pre_shared_key)
...
class SrvPreSharedKeyExtension(IntExtension):
    ...
    def __init__(self):
        """Create instance of class."""
        super(SrvPreSharedKeyExtension, self).__init__(2, 'selected', ext_type=ExtensionType.pre_shared_key)
...
class PskKeyExchangeModesExtension(VarListExtension):
    ...
    def __init__(self):
        """Create instance of class."""
        super(PskKeyExchangeModesExtension, self).__init__(1, 1, 'modes', ExtensionType.psk_key_exchange_modes, PskKeyExchangeMode)
...
class RecordSizeLimitExtension(IntExtension):
    ...
    def __init__(self):
        """Create instance."""
        super(RecordSizeLimitExtension, self).__init__(2, 'record_size_limit', ExtensionType.record_size_limit)
